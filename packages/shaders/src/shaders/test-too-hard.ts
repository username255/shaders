 ...
 * A sea/ocean simulation with waves and lighting
 */
...
// Sea parameters - exposed as uniforms for testing
...
#define SEA_TIME (1.0 + u_time * u_seaSpeed)
...
void main() {
    // Use normalized mouse position for camera control
    float time = 0.6 + (u_mouse.x / u_resolution.x) * 0.01;
